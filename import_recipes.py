...
def parse_and_load_recipes(csv_file_path):
    fieldnames = [
        ...
        'ingredients', 'ingredient_amounts', 'is_vegetarian', 'is_breakfast', 
        'is_lunch', 'is_snack', 'is_dinner', 'energy_per_serving_kcal',
        'carbohydrate_per_serving_g', 'protein_per_serving_g', 'fat_per_serving_g',
        'fiber_per_serving_g', 'instructions'  # Add instructions field
    ]
        ...
        for row in reader:
            ...
            try:
                recipe = Recipe(
                    ...
                    instructions=row['instructions'].strip() if row['instructions'] else "",
